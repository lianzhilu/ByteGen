...
def add_model_args(parser):
    ...
    data.add_argument('--max_src_len', type=int, default=384,
                      help='Maximum allowed length for the source sequence')
    data.add_argument('--max_cfg_len', type=int, default=384,
                      help='Maximum allowed length for the source sequence')
    data.add_argument('--max_tgt_len', type=int, default=30,
    ...
    data.add_argument('--use_cfg_type', type='bool', default=False,
                      help='Use code type as additional feature for feature representations')
    data.add_argument('--code_tag_type', type=str, default='subtoken',
                      help='Use code type as additional feature for feature representations')
    data.add_argument('--cfg_tag_type', type=str, default='subtoken',
                      help='Use code type as additional feature for feature representations')
    ...
    model.add_argument('--cfg_pos_emb', type='bool', default=False,
                       help='Use positional embeddings in encoder')
    ...
    model.add_argument('--max_relative_pos', nargs='+', type=int,
                       default=32, help='Max value for relative position representations')
    ...
    model.add_argument('--use_cfg_char', type='bool', default=False,
                       help='Use character embedding in the cfg')
    ...
    model.add_argument('--use_cfg_word', type='bool', default=True,
                       help='Use word embedding in the input')
    ...
    optim.add_argument('--learning_rate', type=float, default=0.0001,  # 0.0001
